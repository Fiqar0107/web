// screens/drive-integration.jsx — admin: Google Drive sebagai sumber data
const DriveIntegrationScreen = ({ role = "admin" }) => {
  const folders = [
  ...
  return (
    <div className="app">
      ...
      <div className="shell">
        ...
        <div className="main">
          <SubBar
            crumbs={["Repositori", "Integrasi Google Drive"]}
            meta="Akun: prodi-abi@drive · 2.408 file terindeks · last sync 09:38"
          />
            ...
            <div className="card" style={{ marginBottom: 12 }}>
              <div className="card-body" style={{ display: "grid", gridTemplateColumns: "auto 1fr auto", gap: 18, alignItems: "center" }}>
                <div style={{ width: 48, height: 48, borderRadius: 10, background: "var(--surface-3)", display: "grid", placeItems: "center" }}>
                  {/* Generic cloud icon — not the Drive logo */}
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(4, auto)", gap: 18, textAlign: "right" }}>
                  <div>
                    <div className="smallcaps">Folder</div>
                    <div className="mono num" style={{ fontSize: 18, fontWeight: 600 }}>8</div>
                  </div>
                  <div>
                    <div className="smallcaps">File</div>
                    <div className="mono num" style={{ fontSize: 18, fontWeight: 600 }}>2.408</div>
                  </div>
                  <div>
                    <div className="smallcaps">Index</div>
                    <div className="mono num" style={{ fontSize: 18, fontWeight: 600 }}>2.399</div>
                  </div>
                  <div>
                    <div className="smallcaps">Sinkron</div>
                    <div className="mono num" style={{ fontSize: 13, fontWeight: 600 }}>09:38</div>
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <tbody>
                      {folders.map((f) => (
                        <tr key={f.path}>
                          ...
                          <td>
                            <span className="badge info">{f.role}</span>
                          </td>
                          ...
                          <td>
                            <button className="btn subtle sm"><Icon name="settings" size={12} /></button>
                          </td>
                        </tr>
                      ))}
                    </tbody>
...
window.DriveIntegrationScreen = DriveIntegrationScreen;
