// screens/title-check.jsx — hasil cek kesamaan judul
const TitleCheckScreen = ({ role = "mahasiswa" }) => {
  ...
  const renderTitleWithHL = (txt) => {
    const map = { "UMKM": "hl-1", "Batik": "hl-2", "Asia Tenggara": "hl-3", "E-Commerce": "hl-4", "Lintas Batas": "hl-3", "Penetrasi Pasar": "hl-1" };
    let out = txt;
          ...
          <div className="workspace">
            <div className="page-head">
              <div>
                ...
                <div className="desc">Dibandingkan terhadap repositori judul prodi 2018–2025 — diindeks dari <span className="mono" style={{ color: "var(--text)" }}>Google Drive · /TA-ABI/*/Final</span>.</div>
              </div>
              <div className="actions">
                ...
                <button className="btn primary">Lanjut: Berkas <Icon name="arrow" size={13} /></button>
              </div>
            </div>
...
window.TitleCheckScreen = TitleCheckScreen;
