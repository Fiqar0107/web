// screens/external-report.jsx — Cek Plagiasi Eksternal · 2 varian
// Original report-viewer UI; conveys sentence-level matches + sources without
// copying any specific service's branded chrome.
...
const docHTML = (
  <>
    ...
    <p>Untuk produk batik, faktor budaya dan persepsi nilai (perceived value) menjadi krusial. <span className="matched s2">Konsumen di Singapura, Malaysia, dan Filipina menunjukkan kesediaan membayar lebih tinggi untuk produk batik tulis dengan narasi asal-usul yang jelas.</span> Karenanya, storytelling produk menjadi titik leverage strategi penetrasi pasar berbasis e-commerce.</p>
  </>
);

// ---------- Variant A · Three-pane ----------
const ExternalReportA = ({ role = "mahasiswa" }) => {
  ...
  return (
    <div className="app">
      ...
      <div className="shell">
        ...
        <div className="main">
          <SubBar
            crumbs={["Pengajuan #SBM-2026-0184", "Plagiasi · Eksternal"]}
            meta="via Turnitin · selesai 6 menit lalu · ID 1834-A09F"
          />
          <div className="workspace" style={{ padding: 0, display: "flex", flexDirection: "column" }}>
            ...
            <div style={{ padding: "12px 16px", borderBottom: "1px solid var(--border)", display: "flex", gap: 12, alignItems: "center", background: "var(--surface)" }}>
              ...
              <div style={{ marginLeft: "auto", display: "flex", gap: 6 }}>
                ...
                <button className="btn primary"><Icon name="check" size={13} /> Tandai Selesai</button>
              </div>
            </div>

            {/* Three pane reader */}
            <div style={{ flex: 1, display: "grid", gridTemplateColumns: "240px 1fr 320px", minHeight: 0 }}>
              {/* Left: doc outline + filters */}
                ...
                <div style={{ padding: 12, display: "flex", flexDirection: "column", gap: 10 }}>
                  ...
                  <div>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 4, fontSize: 12 }}>
                      ...
                      <label style={{ display: "flex", alignItems: "center", gap: 8, padding: "3px 0" }}><input type="checkbox" /> Pengulangan tabel</label>
                    </div>
                  </div>
                  <div className="hr" />
                  <div>
              ...
              <div style={{ background: "var(--surface)", overflow: "auto", padding: "20px 36px" }}>
                <div style={{ maxWidth: 640, margin: "0 auto" }}>
                  ...
                  <div className="doc-reader">{docHTML}</div>
              ...
              <div style={{ borderLeft: "1px solid var(--border)", background: "var(--surface)", display: "flex", flexDirection: "column", minHeight: 0 }}>
                    ...
                    <div key={s.rank} className={"source-item " + s.color + (i === active ? " active" : "")} onClick={() => setActive(i)}>
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                          <span style={{ fontWeight: 500, lineHeight: 1.35 }}>{s.title}</span>
                        </div>
                        <div className="src-meta mono">
                          {s.host} · {s.type} · {s.year}
                        </div>
                      </div>
                ...
                <div style={{ padding: 12, borderTop: "1px solid var(--border)", fontSize: 11, color: "var(--text-muted)", background: "var(--surface-2)" }}>
                  Sumber yang tidak dapat diakses publik ditampilkan tanpa tautan langsung. Hubungi admin untuk akses penuh.
                </div>
              </div>
            </div>
          </div>
...
// ---------- Variant B · Annotated single column ----------
const ExternalReportB = ({ role = "admin" }) => {
  return (
    <div className="app">
      <Topbar active="submission" role={role} />
      <div className="shell">
        ...
        <div className="main">
          <SubBar
            crumbs={["Antrian Verifikasi", "SBM-2026-0184", "Eksternal"]}
            meta="via Turnitin · ID 1834-A09F · diverifikasi oleh Admin"
          />
          <div className="workspace">
            <div className="page-head">
              ...
              <div className="actions">
                ...
                <button className="btn"><Icon name="download" size={13} /> Laporan PDF</button>
                <button className="btn primary"><Icon name="flag" size={13} /> Setujui</button>
              </div>
            </div>
              ...
              <div className="card">
                ...
                <div className="card-body" style={{ position: "relative", paddingRight: 36 }}>
                  <div className="doc-reader">
                    <p>Internasionalisasi UMKM kini ditopang oleh kanal digital yang memangkas hambatan masuk pasar luar negeri. <span className="matched s1" style={{ position: "relative" }}>Berbagai studi menunjukkan bahwa adopsi e-commerce lintas batas memungkinkan UMKM menjangkau konsumen mancanegara tanpa harus membangun jaringan distribusi fisik di negara tujuan.<span style={{ position: "absolute", right: -28, top: 0, width: 22, height: 18, borderRadius: 4, background: "var(--red)", color: "white", fontFamily: "var(--ff-mono)", fontSize: 10, display: "inline-grid", placeItems: "center" }}>1</span></span> Hal ini memberikan ruang ekspansi yang sebelumnya hanya dimiliki oleh pelaku skala besar.</p>
                    ...
                    <p>Karakteristik pasar Asia Tenggara — populasi muda, penetrasi smartphone yang tinggi, serta literasi digital yang meningkat — menjadikannya target alami bagi UMKM Indonesia. <span className="matched s3" style={{ position: "relative" }}>Data Kementerian Perdagangan menunjukkan transaksi lintas batas dari Indonesia ke negara-negara ASEAN tumbuh rata-rata 28% per tahun pada periode 2021–2024.<span style={{ position: "absolute", right: -28, top: 0, width: 22, height: 18, borderRadius: 4, background: "var(--violet)", color: "white", fontFamily: "var(--ff-mono)", fontSize: 10, display: "inline-grid", placeItems: "center" }}>3</span></span></p>

                    <h3 style={{ fontSize: 14, margin: "12px 0 8px", fontWeight: 600 }}>2.1 Strategi Penetrasi Pasar</h3>
                    <p>Konsep penetrasi pasar dalam literatur pemasaran internasional umumnya merujuk pada upaya meningkatkan pangsa pasar pada kategori produk yang sudah ada.</p>

                    <p><span className="matched s2">Konsumen di Singapura, Malaysia, dan Filipina menunjukkan kesediaan membayar lebih tinggi untuk produk batik tulis dengan narasi asal-usul yang jelas.</span> Storytelling produk menjadi titik leverage.</p>
                  </div>
...
window.ExternalReportA = ExternalReportA;
window.ExternalReportB = ExternalReportB;
