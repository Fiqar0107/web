...
import { Icon, Brand } from '../components/shared'

export default function LoginScreen() {
  const [role, setRole] = useState("mahasiswa")
  const { setRole: setAppRole, setLoggedIn } = useApp()
      ...
      <div className="auth-shell">
        ...
        <div className="auth-form-wrap">
          <div className="auth-form">
            ...
            <button className="btn primary" style={{ width: "100%", height: 36, justifyContent: "center" }} onClick={handleLogin}>
            ...
            <button className="btn" style={{ width: "100%", height: 36, justifyContent: "center" }} onClick={handleLogin}>
