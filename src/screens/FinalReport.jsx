  ...
  return (
    <div className="app">
      ...
      <div className="shell">
        ...
        <div className="main">
          <SubBar crumbs={["Pengajuan #SBM-2026-0184", "Berita Acara Final"]} meta="Status: Selesai · 4 dari 4 tahap lolos · siap diunduh" />
          <div className="workspace">
            ...
            <div className="card" style={{ background: "var(--surface-2)", padding: 24, marginBottom: 12 }}>
              <div style={{
              ...
              <div className="card">
                ...
                <div className="card-body" style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                  ...
                  <div style={{ fontSize: 11, color: "var(--text-muted)" }}>
                    Tanda tangan elektronik tersertifikasi BSrE. Stempel waktu kriptografis tertanam pada PDF.
                  </div>
                </div>
              </div>
